#!/usr/bin/env node
/**
 * Test script for LLM integration with LangGraph workflow
 * Run: npx ts-node src/ai/test-llm.ts
 */
...
async function runTest(): Promise<void> {
  console.log('🚀 Starting LLM + LangGraph Workflow Test\n');
  console.log('='.repeat(60));

  try {
    // Step 0: Verify configuration
    console.log('\n0️⃣  Verifying LLM configuration...');
    ...
    console.log(`\n1️⃣  Initializing AI module with ${provider}...`);
    initializeAIModule();
